...
function renderProgress(data) {
  ...
  const forceBtn = data.mode === "peace"
    ? `<button class="gram-cta secondary" id="forceMasterBtn" style="margin-top:12px">Marcar "may / might (posibilidad y permiso)" como dominado</button>`
    : "";
  ...
  if (fmBtn) fmBtn.addEventListener("click", () => forceMasterTopic("may_might_possibility_permission", fmBtn));
}

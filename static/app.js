...
function renderProgress(data) {
  ...
  const forceBtn = data.mode === "peace"
    ? `<button class="gram-cta secondary" id="forceMasterBtn" style="margin-top:12px">Marcar "Causativo (have/get something done)" como dominado</button>`
    : "";
  ...
  if (fmBtn) fmBtn.addEventListener("click", () => forceMasterTopic("causative_have_get", fmBtn));
}

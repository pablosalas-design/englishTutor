...
function renderProgress(data) {
  ...
  const forceBtn = data.mode === "peace"
    ? `<button class="gram-cta secondary" id="forceMasterBtn" style="margin-top:12px">Marcar "unless / provided / as long as" como dominado</button>`
    : "";
  ...
  if (fmBtn) fmBtn.addEventListener("click", () => forceMasterTopic("conditionals_unless_provided_as_long_as", fmBtn));
}
